                ...
                <div class="btn-group float-right">
                    <div class="float-right" style="margin-left: 60rem">
                        ...
                        <ul class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <li class="btn-group">
                                <a href="index.php?controller=MyDoc/createdoc" class="pm_item" data-toggle="dropdown"
                                   title="login">
                        ...
                        <div class="dropdown-menu col-sm-12" style="width: 200px; ">
                            <div class="dd-wrapper" style="font-size: 14px">
                                <div id="dd_login">
                                    <div class="form-group text-center">
                                        <a href="controller/author/index.php?controller=MyDoc/createdoc">Đăng tài
                                            liệu</a>
                                    </div>
                                </div>
                    ...
                    <div class="btn-group">
                        <a href="controller/author/index.php?act=Register">Đăng ký</a>
                    </div>
                    </ul>
                </div>
                </li>
        ...
        <div class="container">
            <nav class="main-menu">
                <ul class="nav-menu" style="">
                    ...
                    <li class="nav-item" style="width: 200px">
                        <a style="color: black;">
                            <i class="icon-screen-desktop"></i> Lĩnh vực
                        </a>
                        ...
                        <div class="float-right">
                            <div class="dropdown-menu col-sm-12" style="background: #65B4CB">
                                <ul class="dd-wrapper">
                                    <?php foreach ($areas as $key => $area) { ?>
                                        <li class="form-group text-center" style="font-size: 18px;">
                                            <a href="controller/author/index.php?area_id=<?php echo $area['id']; ?>"
                                               style="color: black">
                    ...
                    <li class="nav-item" style="width: 200px">
                        <?php if($isLogin){ ?>
                            <a href="controller/author/index.php?controller=MyDoc/listdoc" style="color: black;">
                        <?php } else { ?>
                            <a href="controller/author/index.php?act=login" style="color: black;">
                        <?php } ?>
                            <span><i class="icon-user-female"></i>Tài liệu của tôi</span>
                        </a>
                    </li>
...
<div class="modal fade" id="product-added" tabindex="-1" role="dialog" aria-labelledby="product-added"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="row no-gutter">
                    ...
                    <div class="col-xs-6">
                        <button type="button" class="btn btn-md btn-third-col btn-w100" data-dismiss="modal">Continue
                            Shopping
                        </button>
                    </div>
                </div>
